...
The predicted number of bugs for release 92 is around bugs 19.15 given both the covariate vector for release 92 and our model. Note that we have to use exp() for our betas.
...
pred <- predict(modelito, newdata = new_obs, type = "response")
